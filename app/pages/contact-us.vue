<template>
    ...
    <main class="wrapper py-24 pt-32 sm:pt-48 sm:pb-32">
        <div
            ...
            <form @submit.prevent="submitForm" class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        v-model="name"
                        required
                        class="focus:outline-primary-500 h-12 rounded-lg border border-white/10 bg-neutral-800 px-4 focus:outline-2 focus:outline-offset-2 focus:outline-none"
                    />
                </div>
                <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea
                        ...
                        v-model="message"
                        required
                        class="focus:outline-primary-500 h-32 rounded-lg border border-white/10 bg-neutral-800 px-4 py-2 focus:outline-2 focus:outline-offset-2 focus:outline-none"
                    ></textarea>
                </div>
                <button
                    type="submit"
...
const { data: contactUs } = await useLocalizedContent(
    "contact-us-page",
    "shared/contact-us"
);
